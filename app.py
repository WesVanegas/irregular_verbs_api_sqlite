...
def add_multiple_verbs():
    ...
    for item in data:
        if (
            "verb" in item
            and "past" in item
            and "past_participle" in item
            and "example_one" in item
        ):
            new_verb = Verb(
                verb=item["verb"],
                past=item["past"],
                past_participle=item["past_participle"],
                example_one=item["example_one"],
                example_two=item["example_two"],
            )
            try:
                db.session.add(new_verb)
                db.session.commit()
        ...
        output.append(
            {
                ...
                "example_one": verb.example_one,
                "example_two": verb.example_two,
            }
        )
...
def get_verb(verb):
    ...
    if verb_detail:
        return jsonify(
            {
                "verb": verb_detail.verb,
                "past": verb_detail.past,
                "past_participle": verb_detail.past_participle,
                "example_one": verb_detail.example_one,
                "example_two": verb_detail.example_two,
            }
        )
    else:
